...
import com.alex.connector.ResponseStream;
import com.alex.connector.ResponseWriter;
...
public class HttpResponse implements HttpServletResponse{
    public void sendStaticResource() {
        ...
        try {
            File file = new File(Const.ROOT+request.getRequestURI());
            if(file.exists()){
                fileInputStream = new FileInputStream(file);
                int chr = fileInputStream.read(bufer,0,1024);
                while(chr!=-1){
                    output.write(bufer);
                    chr = fileInputStream.read(bufer,0,1024);
                }
            }else{
